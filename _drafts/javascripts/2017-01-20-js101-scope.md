...
Left Hand Side คือค่าที่อยู่ฝั่งซ้ายมือของ `=` เป็นแค่การหา Reference ของตัวแปรนั้นๆ<br>
...
หลักการคร่าวๆก็จะประมานนี้เพื่อให้ได้เห็นภาพกันนะครับ คงพอจะได้เห็นได้ว่า Compiler และ Engine นั้นมีหน้าที่คอมไพล์และรันโปรแกรม แต่ `Scope` นั้นทำหน้าที่หาตำแหน่งที่อยู่ของตัวแปรในโปรแกรมให้กับ Engine แต่อาจจะสงสัยว่าทำไมต้องหาด้วยละ ตัวแปรก็น่าจะมีที่เดียวอยู่แล้ว เดี๋ยวเรามาดูรายละเอียดกันครับ
...
เนื่องมาจากฟังก์ชันนั้นไม่ได้ในรันในทันที เมื่อฟังก์ชันนั้นถูกรันภายหลัง ก็จะมองหาตัวแปร `i` ซึ่งตัวแปร i ใน scope นั้น ซึ่งกลายเป็นค่าที่ถูกบวกไปเรื่อยๆตาม loop ไปแล้ว จึงได้ค่าเป็น 10 นั่นเอง
