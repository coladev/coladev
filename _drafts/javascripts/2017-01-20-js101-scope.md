...
หลักคร่าวๆก็จะประมานนี้เพื่อให้ได้เห็นภาพกันนะครับ คงพอจะได้เห็นได้ว่า Compiler และ Engine นั้นมีหน้าที่คอมไพล์และรันโปรแกรม แต่ `Scope` นั้นทำหน้าที่หาตำแหน่งที่อยู่ของตัวแปรในโปรแกรมให้กับ Engine แต่อาจจะสงสัยว่าทำไมต้องหาด้วยละ ก็น่าจะมีที่เดียวอยู่แล้ว เดี๋ยวเรามาดูรายละเอียดกันครับ
...
การหาค่าของตัวแปรนั้น จะเป็นการหาค่าแบบ `Down>>Top` คือ หาใน Scope ตัวเองเสร็จ หาไม่เจอ ก็จะค่อยๆหาขึ้นไปใน Parent Scope ขึ้นไปเรื่อยๆจนถึง Global Scope เมื่อเจอตัวแปรที่ Scope ที่ใกล้ที่สุดก็ใช้ตัวแปรนั้นในการรันครั้งนันๆ โดย Scope ที่หานั้น จะดูจาก Scope ที่ฟังก์ชันนั้นถูกเรียก หรือที่เรียกว่า call-site
...
`this` เป็นตัวแปรที่อ้างอิงอยู่กับ scope นั้นตามที่อธิบายไปในห้วข้อก่อน และการทำ Variable Loop ก็มีหลักการเช่นเดียวกันกับตัวแปรทั่วไป คือหาแบบ `Down >> Top` จนถึง global scope เหมือนกัน
