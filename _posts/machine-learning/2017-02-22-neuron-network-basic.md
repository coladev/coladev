---
layout: post
title:  "สรุปแนวคิด Neuron Network แบบไม่มี Math"
subtitle: "เข้าใจพื้นฐานของ Machine Learning แบบ Neuron Network โดยไม่ต้องรู้ Math !!"
...
- `Input` หรือค่าที่ส่งเข้ามาที่ Nueron โดยจะมีขาที่เข้ามาได้หลายขา ขึ้นอยู่กับเราจะสร้าง
...
![Feed Forward Neuron Network](/assets/images/posts/neuron/feed-forward.png)
